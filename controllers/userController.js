...
exports.forgotPassword = BigPromise(async (req, res, next) => {
    ...
    await user.save({ validateBeforeSave: false });//! we had done all verification not wanted to reverify --> some time may give error --> thus save this as it is
...
exports.adminUpdateOneUser = BigPromise(async (req, res, next) => {
    ...
    if (!name) {
        next(new CustomError("Name  must require ", 400));
